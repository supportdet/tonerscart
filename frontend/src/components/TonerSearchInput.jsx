 ...
 *  - Empty-result state shows a clear "no suggestions" CTA hint */
        ...
        <div ref={wrapperRef} className="relative w-full">
            ...
            {showDropdown && (
                ...
                >
                    ...
                    {!loading && hasResults && suggestions.map((s, i) => (
                        <button
                            type="button"
                            role="option"
                    ...
                    {!loading && !hasResults && (
                        <div className="px-4 py-3 text-[12.5px] text-[#6E6E73]" data-testid="search-suggest-empty">
                            No suggestions — press <strong className="text-[#0A0A0B]">Search</strong> to browse all.
                        </div>
                    )}
                </div>
            )}
