 ...
 * consumables, scanners). Each chip uses the brand's official color; the
 * active chip is filled. "All" resets the filter.
 *
 * Props:
 *   value: currently selected brand ("" = all)
 *   onChange(brand): "" for All, or the brand name
 */
