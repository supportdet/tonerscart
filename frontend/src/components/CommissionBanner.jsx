    ...
    return (
        ...
        >
            <div className="text-[13.5px] font-semibold mb-2.5">
                This is the price you set — the referral fee comes out of it automatically.
            </div>
            <p className="text-[13px] leading-relaxed text-[#0A0A0B]/85 mb-2.5">
                Make sure this price covers your cost + your profit + the referral fee, all together.
            </p>
            <p className="text-[13px] leading-relaxed text-[#0A0A0B]/85 mb-2.5">
                Example: if you bought it for <strong>₹800</strong>, don&rsquo;t put <strong>₹800</strong> here — you&rsquo;ll lose money.
                Put a price that leaves you a good profit after the referral fee is deducted.
            </p>
            <p className="text-[12px] leading-relaxed text-[#0A0A0B]/65 mt-3" data-testid="commission-slabs-line">
                TonersCart deducts a flat referral fee from your base price on every completed order.
                GST and delivery flow through to you in full.
            </p>
        </div>
    );
}
