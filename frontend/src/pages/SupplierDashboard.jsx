                                    ...
                                    <tbody>
                                        {visibleOrders.map((o) => (
                                            <tr key={o.id} className="border-t border-black/[0.05]">
                                                ...
                                                <td className="p-3"><span className="font-semibold text-[#0A0A0B]">{o.customer_name}</span><div className="text-[11.5px] text-[#3a3a40] font-medium">{o.customer_phone}</div>{(o.buyer_email || o.customer_email) && (<div className="text-[11px] text-[#3a3a40] font-medium mt-0.5 truncate max-w-[200px]" title={o.buyer_email || o.customer_email}><a href={`mailto:${o.buyer_email || o.customer_email}`} className="text-[#00838f] hover:underline">{o.buyer_email || o.customer_email}</a></div>)}<div className="text-[11px] text-[#3a3a40] font-medium mt-1 max-w-[240px] leading-tight" data-testid={`order-address-${o.id}`}><span className="uppercase tracking-wider text-[9.5px] text-[#86868B] font-bold">Deliver to</span><br/>{[o.street_address, o.area, o.order_city, o.pincode, o.order_state].filter(Boolean).join(", ") || o.delivery_address || "—"}</div></td>
